...
<!--      <el-form-item label="ID" v-if="data.type!='grid'">-->
...
<!--      </el-form-item>-->
      ...
      <el-form-item label="Searchable" v-if="data.type==='select'">
      ...
      >
        <el-radio-group v-model="data.options.remote" size="mini" style="margin-bottom:10px;">
          ...
          <el-radio-button :label="true">Remote Date</el-radio-button>
        </el-radio-group>
...
<!--      </el-form-item>-->
      ...
      <template v-if="data.bgIcon">
        <el-form-item label="Иконка">
          <el-select v-model="data.style.className" placeholder="Выберите иконку" style="width: 100%;">
            <el-option
                    v-for="icon in icons"
                    class="icon"
                    :class="icon.value"
...
<!--      </template>-->
      ...
      <template v-if="data.type != 'grid'">
        <el-form-item label="Attribute Action">
          <el-checkbox
